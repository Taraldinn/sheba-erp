...
try {
    ...
    echo "Insert Succeeded on shebafi_minhaj! New ID: " . $pdo->lastInsertId() . "\n";
    
    // Clean up
    $pdo->prepare("DELETE FROM tenant_payment_gateways WHERE device_id = 'test_device_insert'")->execute();
    echo "Cleanup Succeeded!\n";
} catch (Exception $e) {
    echo "Error inserting gateway on shebafi_minhaj: " . $e->getMessage() . "\n";
}
?>
